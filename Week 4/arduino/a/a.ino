...
#include <LiquidCrystal.h>  // Menambah library untuk mengakses lcd
#define btn1 A0             // Definisi pin button
String msg = "KEDIP";       // Pesan yang akan dikirim
...
void loop() {
  ...
  if (Serial.available()){
    ...
    Serial.println(data);       // Print di virtual terminal
  ...
  if (n1==0) {
    ...
    Serial.println(msg);    // Menampilkan pesan ke virtual terminnal
    lcd.setCursor(0,1);     // Menempatkan cursor pada alamat array(0,1)
